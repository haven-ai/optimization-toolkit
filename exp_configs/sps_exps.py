...
EXP_GROUPS['sps_syn'] = hu.cartesian_exp_group(get_benchmark(benchmark='syn', opt_list=sps_list_mom_gamma))
EXP_GROUPS['sps_mnist'] = hu.cartesian_exp_group(get_benchmark(benchmark='mnist', opt_list=sps_list_mom_gamma))